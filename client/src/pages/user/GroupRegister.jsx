    ...
    const fetchData = async () => {
      try {
        if (props.listClassroom.length !== 0) {
          ...
          let listClassroom = await getAllClassroom();

          if (listClassroom.data.errCode !== 0) {
            console.log("classroom not found");
            setLoadingData(false);
          } else {
            listClassroom.data.classroom = listClassroom.data.classroom.filter(
              (item) => item.maCB === props.userData.maCB
            );
        ...
        // if (props.listClassroom.length !== 0) {
        //   const filteredArr = props.listClassroom.filter(
        //     (item) => item.maCB === "CB002"
        //   );
        //   props.setListClassroom(filteredArr);
        // //   console.log("check list filter:", filteredArr);
        // }
...
export default connect(mapStateToProp, mapDispatchToProps)(GroupRegister);
