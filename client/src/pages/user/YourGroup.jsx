...
const YourGroup = (props) => {
    ...
    const fetchData = async () => {
      try {
        if (props.listGroup.length !== 0) {
          ...
          let listGroup = await getAllGroup();

          if (listGroup.data.errCode !== 0) {
            console.log("group not found");
            setLoadingData(false);
          } else {
            listGroup.data.group = listGroup.data.group.filter(
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row bg-white p-4 fs-4 fw-semibold">Nhóm của bạn</div>
...
export default connect(mapStateToProp, mapDispatchToProps)(YourGroup);
